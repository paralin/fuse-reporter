...
var (
	filter_ReporterService_GetBoundedStateHistory_0 = &utilities.DoubleArray{Encoding: map[string]int{"context": 0, "component": 1, "state_id": 2}, Base: []int{1, 1, 1, 2, 0, 0}, Check: []int{0, 1, 2, 2, 3, 4}}
)

func request_ReporterService_GetBoundedStateHistory_0(ctx context.Context, marshaler runtime.Marshaler, client ReporterServiceClient, req *http.Request, pathParams map[string]string) (ReporterService_GetBoundedStateHistoryClient, runtime.ServerMetadata, error) {
	var protoReq BoundedStateHistoryRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_ReporterService_GetBoundedStateHistory_0); err != nil {
		return nil, metadata, grpc.Errorf(codes.InvalidArgument, "%v", err)
	}

	stream, err := client.GetBoundedStateHistory(ctx, &protoReq)
	if err != nil {
		return nil, metadata, err
	}
	header, err := stream.Header()
...
func RegisterReporterServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("GET", pattern_ReporterService_GetBoundedStateHistory_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(ctx)
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_ReporterService_GetBoundedStateHistory_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, outboundMarshaler, w, req, err)
			return
		...
		forward_ReporterService_GetBoundedStateHistory_0(ctx, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_ReporterService_GetBoundedStateHistory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"v1", "view", "context.component", "context.state_id", "boundedhistory"}, ""))
)
...
var (
	...
	forward_ReporterService_GetBoundedStateHistory_0 = runtime.ForwardResponseStream
)
